...
bool Dome::Interpolar1() {
	...
	if (elapsedTime <= cicloLuz) {
		...
		cicloInterpolacionSeg = 600; // Lo que me demoro en cambiar a la siguiente textura
...
bool Dome::Interpolar2() {
	...
	if (elapsedTime <= cicloLuz) {
		...
		cicloLuz = 360; //Segundos en que permanece la textura actual
		cicloInterpolacionSeg = 700; // Lo que me demoro en cambiar a la siguiente textura
		// definimos el color que se supone debe inicializar para la siguiente fase
...
bool Dome::Interpolar3() {
	...
	if (elapsedTime <= cicloLuz) {
		...
		cicloLuz = 360; //Segundos en que permanece la textura actual
		cicloInterpolacionSeg = 800; // Lo que me demoro en cambiar a la siguiente textura
		// definimos el color que se supone debe inicializar para la siguiente fase
		RedefineColor((255.00f / 255.00f),
			(255.00f / 255.00f),
			(255.00f / 255.00f),
